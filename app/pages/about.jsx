        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-5 align-self-center">
              ...
              >
                <p>
                  Ever since its founding in 2011, Z&N Restaurant group aims to create a diverse array of restaurants to showcase different flavors of China. We have restaurants that offer Chinese BBQ, traditional Chinese cuisine and even cafes. Now, we believe it’s time to introduce us to Boston. 
                </p>
                <br></br>
                <p>
                  While Hao Shi Guang means “Good Times" in simple Chinese translation, the pun suggests otherwise. The guest will not only have a good time here, but the delicacy on their plate will also be emptied by the time they leave the restaurant. 
                </p>
                <br></br>
                <p>
                  Devotion, precision, and determination are words to live by everyday here in Hao Shi Guang. 
                  Each food is freshly prepared, day in and day out, by our chefs. And their ingredients? Passion and love 
                </p>
                <br></br>
                <p>
                  Food has always been one of the most important cultures and traditions in China. We believe good food and company can bring unity within family and friends and facilitate the development of relationships. And our mission here at Hao Shi Guang is for you to trace back your memory to that time where food is the reason you are smiling. 
                </p>
              </div>
              {/*}
